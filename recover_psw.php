    ...
    if(isset($_POST["recover"])){
        ...
        if(mysqli_num_rows($sql) <= 0){
           ...
           <?php
            ...
            // h-hotel account
            $mail->Username='stebinbabu2023b@mca.ajce.in';
            $mail->Password='Stebinbabu@333';

            // send by h-hotel email
            $mail->setFrom('stebinbabu2023b@mca.ajce.in', 'Password Reset');
            ...
            http://localhost/lumia/reset_psw.php
            <br><br>
            <p>With regrads,</p>
            <b>Akalakunnam grama panchayat</b>";
